    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('civil_status', models.CharField(blank=True, choices=[('MARRIED', 'Married'), ('SINGLE', 'Single'), ('DIVORCED', 'Divorced'), ('WIDOWED', 'Widowed')], default='SINGLE', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crop_planted', models.CharField(blank=True, choices=[('Rice', 'Rice'), ('Corn', 'Corn'), ('Sugarcane', 'Sugarcane')], default='Rice', max_length=9, null=True)),
                ...
                ('muncity', models.CharField(max_length=200)),
                ('brgy', models.CharField(max_length=200)),
                ('farmer_id', models.ForeignKey(db_column='farmer_id', on_delete=django.db.models.deletion.CASCADE, to='dashboard.farmer')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farmer', models.ForeignKey(db_column='farmer', on_delete=django.db.models.deletion.CASCADE, to='dashboard.farmer')),
            ],
        ),
        migrations.CreateModel(
            name='AreaCrop',
            fields=[
                ...
                ('remarks', models.CharField(blank=True, max_length=100, null=True)),
                ('area_id', models.ForeignKey(db_column='area_id', default=None, on_delete=django.db.models.deletion.CASCADE, to='dashboard.usersareainfo')),
            ],
        ),
    ]
